...
- **QR signatures**: RSA-PSS over canonical-JSON payloads, SHA-256, 2048-bit keys by default. There is no encryption layer, because the payload is non-sensitive (SBD + round + subject + result + issued_at).
