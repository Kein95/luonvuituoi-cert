...
Points (1/72 of an inch). Following the reportlab convention, the origin is the **bottom-left corner** of the page. A landscape A5 page is `(842, 595)`; "one inch from the bottom" is `y = 72`.
...
- Non-string values are coerced via `str()` after length-check. Numbers, booleans, and similar values render as their string forms.
